...
# If we add up d and number greater than zero, then we had responses with the same birthday.
if(sum(d)>0){
  savebank=savebank+1
}else{
...
After adjusting the amount Brownlow pays out, we determined that the most fair 
odds are a 4.30:1 ratio. 
...
We began this problem by responding to the third question first. We began by determining how much money Brownlow would make if the bet, with 2:1 odds, was completed 637 times. Then we ran this 1000 times to find the 95% confidence interval. The class size that makes 2:1 was 28 people we found that by trying different size classes until we got the 0 in the middle of the histogram.    